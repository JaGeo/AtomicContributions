...
#hier eine plotfunktion schreiben, die alte plotfunktion ausnutzt, aber IR und Raman aktive Moden selbst ermittelt und dann entsprechende Listen an zweite Plotfunktion weitergibt
