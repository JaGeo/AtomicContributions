...
class AtomicContributionToModesTest(unittest.TestCase):
    def setUp(self):
        ...
        self.Contributions2 = AtomicContributionToModes(PoscarName='POSCAR.NaCl', ForceConstants=False, ForceFileName='FORCE_SETS.NaCl',
                                         supercell=[[2, 0, 0], [0, 2, 0], [0, 0, 2]],nac=True,BornFileName='BORN.NaCl',
